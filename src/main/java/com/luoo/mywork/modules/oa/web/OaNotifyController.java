...
//		model.addAttribute("page", page);
	...
	@ResponseBody
	public Object newlist(OaNotify oaNotify, HttpServletRequest request, HttpServletResponse response, @RequestBody JSONObject jsonObj) {

		String title = jsonObj.getString("title");
		String type = jsonObj.getString("type");
		String status = jsonObj.getString("status");
		Boolean self = jsonObj.getBoolean("self");

		oaNotify.setTitle(title);
		oaNotify.setType(type);
		oaNotify.setStatus(status);
		oaNotify.setSelf(self);
		...
		try {
			...
			Page<OaNotify> page = oaNotifyService.find(new Page<OaNotify>(pageNumber, pageSize), oaNotify);
