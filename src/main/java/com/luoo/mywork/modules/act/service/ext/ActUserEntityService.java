...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.luoo.mywork.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.luoo.mywork.modules.sys.entity.User(null, userId)))){
