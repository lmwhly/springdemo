(function(a) {
	a.jBox = function(b, c) {
		...
		j.push('<div class="jbox-help-button jbox-button-panel" style="height:25px;display:none;"></div>');
		...
		a.each(b, function(N, O) {
			...
			r.push('<div style="min-width:50px;width:' + (typeof c.width == 'number' ? c.width + 'px' : 'auto') + '; height:' + Q + ';">' + R + '<div id="jbox-content" class="jbox-content" style="height:' + Q + ';">' + O.content + '</div></div>');//overflow:hidden;overflow-y:auto;
			r.push('<div class="jbox-button-panel" style="height:25px;text-align: right;' + (P ? '' : 'display:none;') + '">');
			if (!c.isTip) {
