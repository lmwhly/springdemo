...
<head>
    <title>portal</title>
    <script src='${ctx}/static/portal/dashboard.js' type='text/javascript'></script>
    <link rel='stylesheet' href='${ctx}/static/portal/dashboard.css' type='text/css' media='screen'/>
    <script type="text/javascript" src="${ctx}/static/portal/portal.js"></script>
</head>
            ...
            <div class="portal-col col-md-4 col-sm-6" data-id="${entry.key}" data-order="${entry.key}">
                <c:forEach items="${entry.value}" var="item">
                    <div data-id="${item.id}" class="portlet" data-order="${item.rowIndex}">
                        <div data-url="${ctx}${item.portalWidget.url}" class="panel panel-default" id="panel${item.id}"
                             data-id="${item.id}">
