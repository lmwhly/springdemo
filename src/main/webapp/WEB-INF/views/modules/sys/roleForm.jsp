...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">归属机构:</label>
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">角色名称:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">英文名称:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">角色类型:</label>
			<div class="col-md-4 col-sm-4 col-xs-4"><%--
				<form:input path="roleType" htmlEscape="false" maxlength="50" class="form-control required"/>
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">是否系统数据:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">数据范围:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">角色授权:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<div class="col-md-offset-2 col-xs-offset-2 col-sm-offset-2">
				<c:if test="${(role.sysData eq fns:getDictValue('是', 'yes_no', '1') && fns:getUser().admin)||!(role.sysData eq fns:getDictValue('是', 'yes_no', '1'))}">
					<shiro:hasPermission name="sys:role:edit"><input id="btnSubmit" class="btn btn-primary"
																	 type="submit"
