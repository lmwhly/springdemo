...
<body>
	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">键值:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<form:input path="value" htmlEscape="false" maxlength="50" class="form-control required"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">标签:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">描述:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
