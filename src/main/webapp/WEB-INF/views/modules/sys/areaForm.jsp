...
<body>
	...
	<form:form id="inputForm" modelAttribute="area" action="${ctx}/sys/area/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">上级区域:</label>
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">区域名称:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">区域编码:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<form:input path="code" htmlEscape="false" maxlength="50" class="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">区域类型:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
