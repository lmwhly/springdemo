...
<body>
	...
	<form:form id="inputForm" modelAttribute="office" action="${ctx}/sys/office/save" method="post" class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">上级机构:</label>
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">归属区域:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">机构名称:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">机构编码:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<form:input path="code" htmlEscape="false" maxlength="50" class="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">机构类型:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">机构级别:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">是否可用:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<form:select path="useable">
					<form:options items="${fns:getDictList('yes_no')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
				</form:select>
				<p class="help-block">“是”代表此账号允许登陆，“否”则表示此账号不允许登陆</p>
			</div>

		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">主负责人:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				 <sys:treeselect id="primaryPerson" name="primaryPerson.id" cssClass="form-control" value="${office.primaryPerson.id}" labelName="office.primaryPerson.name" labelValue="${office.primaryPerson.name}"
					title="用户" url="/sys/office/treeData?type=3" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">副负责人:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				 <sys:treeselect id="deputyPerson" name="deputyPerson.id"  cssClass="form-control" value="${office.deputyPerson.id}" labelName="office.deputyPerson.name" labelValue="${office.deputyPerson.name}"
					title="用户" url="/sys/office/treeData?type=3" allowClear="true" notAllowSelectParent="true"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">联系地址:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<form:input path="address" htmlEscape="false" maxlength="50"  cssClass="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">邮政编码:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
				<form:input path="zipCode" htmlEscape="false" maxlength="50"  cssClass="form-control"/>
			</div>
		</div>
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">负责人:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<div class="form-group">
			<label class="col-md-1 col-xs-1 col-sm-2 control-label">传真:</label>
			<div class="col-md-4 col-sm-4 col-xs-4">
		...
		<c:if test="${empty office.id}">
			<div class="form-group">
				<label class="col-md-1 col-xs-1 col-sm-2 control-label">快速添加下级部门:</label>
				<div class="col-md-4 col-sm-4 col-xs-4">
